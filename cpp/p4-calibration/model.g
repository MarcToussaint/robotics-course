...
#for kinect
frame volumeL { shape:ssBox size:[.4 .4 .4 .01] color:[.5 0 0 .2] X:<t(-.2 .85 1.7) d(90 1 0 0)>, noVisual }
frame volumeR { shape:ssBox size:[.4 .4 .4 .01] color:[.5 0 0 .2] X:<t( .2 .85 1.7) d(90 1 0 0)>, noVisual }
