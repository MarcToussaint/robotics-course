...
body eyeL { shape:sphere mass=.1 size=[0 0 0 0.02]  color = [0 0 0]}
body eyeR { shape:sphere mass=.1 size=[0 0 0 0.02] color = [0 0 0]}

body gazeL { type=4 size=[0. 0. 1 0.001] color = [1 1 1]}
body gazeR { type=4 size=[0. 0. 1 0.001] color = [1 1 1]}
...
joint (head eyeL) { joint:hingeX A=<T t(0 0 .05)> B=<T t(0.04 -0.13 .02) d(90 1 0 0)> type = 10 }
joint (head eyeR) { joint:hingeX A=<T t(0 0 .05) > B=<T t(-0.04 -0.13 .02) d(90 1 0 0)> type = 10 }

joint (eyeL gazeL) { joint:hingeX A=<T t(0 0 0)> B=<T t(0 0 0.5)> type = 10 }
joint (eyeR gazeR) { joint:hingeX A=<T t(0 0 0) > B=<T t(0 0 0.5)> type = 10 }
...
body handR    { shape:ssBox mass=.01 size=[.05 .02 .05 .01] }
body handL    { shape:ssBox mass=.01 size=[.05 .02 .05 .01] }
...
body lfoot{ mass=1 size=[.1 .3 .05 .01] shape:ssBox } 
body rfoot{ mass=1 size=[.1 .3 .05 .01] shape:ssBox }
