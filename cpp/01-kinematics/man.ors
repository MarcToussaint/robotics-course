...
body handR    { type=0 mass=.01 size=[.05 .02 .05 .05] }
body handL    { type=0 mass=.01 size=[.05 .02 .05 .05] }
...
body rightTarget { type=1 size=[0 0 0 .03] X=<T t(-0.2 -0.4 1.1)> color=[1 0 0] }
body leftTarget  { type=1 size=[0 0 0 .03] X=<T t( 0.2 -0.4 1.1)> color=[1 0 0] }
